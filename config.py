...
RISK_CONTROL = config.get('RISK_CONTROL', {
    ...
    'server_overload_backoff_seconds': 600,
    'server_overload_backoff_max_seconds': 14400,
    'server_overload_circuit_breaker_threshold': 3,
    'server_overload_circuit_breaker_seconds': 7200,
    'server_overload_manual_recovery_hint_enabled': True,
    'risk_control_freeze_background_tasks': True,
    'risk_control_fallback_notice_cooldown_seconds': 1800,
